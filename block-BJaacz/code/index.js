...
let addTwoToArray = function(arr){
  ...
  for(let number of arr){
    newArray.push(addTwo(number))
  }
  return newArray;
}
addTwoToArray([1,2,3,4,5]);
...
let addThreeToArray = function(arr){
  let newArray = [];
  for(let number of arr){
    newArray.push(addThree(number))
  }
  return newArray;
}
addThreeToArray([1,2,3,4,5]);
...
let addFiveToArray = function(arr){
  let newArray = [];
  for(let number of arr){
    newArray.push(addFive(number));
  }
  return newArray;
}
addFiveToArray([1,2,3,4,5]);
/*
...
let secondone = second();
console.log(secondone(1));
/*
...
let filterAdult=function(array){
  let newArray=[];
  for(let indicies of array)
  if(isAdult(indicies)){
    newArray.push(indicies);
  }
  return newArray;
}
/*
...
*/
let filterFemale=function(array){
  let newArray=[];
  for(let indicies of array)
  if(isFemale(indicies)){
    newArray.push(indicies);
  }
  return newArray;
}
...
*/
let filterGradeA=function(array){
  let newArray=[];
  for(let indicies of array)
  if(isGradeA(indicies)){
    newArray.push(indicies);
  }
  return newArray;
}
...
*/
let filterGradeB=function(array){
  let newArray=[];
  for(let indicies of array)
  if(isGradeB(indicies)){
    newArray.push(indicies);
  }
  return newArray;
}
...
*/
let filterGradeC=function(array){
  let newArray=[];
  for(let indicies of array)
  if(isGradeC(indicies)){
    newArray.push(indicies);
  }
  return newArray;
}
